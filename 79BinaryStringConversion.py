...
Pick any set of indices such that no two picked indices are adjacent. Flip the values at the picked indices
 ...
 then after flipping the values at picked indices, we will get 1?10?110?1→0111111. Note that we cannot pick the 
 set {2,3,5} since 2 and 3 are adjacent indices.
