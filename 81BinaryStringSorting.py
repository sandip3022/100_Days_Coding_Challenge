...
The first line of input will contain a single integer T, denoting the number of test cases. Each test case consists of 22 lines of input. The first line of each test case contains a single integer N — the length of the binary string. 
The second line of each test case contains a binary string S of length N. Output Format
...
Test case 3: We can sort the string in the following way: 1010→ 1100 → 0011. It can be proven that this string cannot be sorted in less than 2 operations.
Test case 4: We can sort the string in the following way: 010101 → 001011→ 000111. It can be proven that this string cannot be sorted in less than 2 operations.
"""
